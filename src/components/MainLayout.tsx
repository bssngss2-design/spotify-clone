      ...
      <div className="h-screen flex flex-col bg-black">
        ...
        <div className="md:hidden flex items-center justify-between p-4 bg-black">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-black border border-spotify-green rounded-full flex items-center justify-center relative">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-spotify-green">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-5 h-0.5 bg-spotify-green rotate-45 absolute"></div>
                <div className="w-5 h-0.5 bg-spotify-green -rotate-45 absolute"></div>
              </div>
            </div>
